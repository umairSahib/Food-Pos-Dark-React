    ...
    <div>
            ...
            <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer1.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px] w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer2.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer3.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
            ...
            <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer4.jpeg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px] w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer5.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer6.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
        ...
        <div className="mt-[64px] flex gap-[18px]">
            <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer7.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer8.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer9.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer10.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer11.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/appetizer12.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
