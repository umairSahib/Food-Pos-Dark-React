  ...
  return (
    <>
     ...
     <div className="flex justify-between items-center">
            ...
            <div className=" flex items-center p-4 bg-[#2D303E] w-56 h-12 rounded border border-#393C49 mr-5">
        ...
        <div className="mt-6 flex justify-between items-center ml-5">
            ...
            <button className="flex items-center justify-center whitespace-pre mr-5 gap-3 bg-[#1F1D2B] text-[#FFFFFF] w-24 h-12 p-4 rounded font-barlow font-normal text-medium hover-bg-[#EA7C69]"><i className="fa-solid fa-angle-down text-[#FFFFFF]"></i><a href="">Dine In</a></button>
        </div>
        <div className="tab">
        <Tabs/>
        </div>
