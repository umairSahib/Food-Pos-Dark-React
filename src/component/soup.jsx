  ...
  return (
    <div>
        <div className="mt-[64px] flex gap-[18px]  ">
            <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup1.jpeg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px] w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup2.jpeg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup3.jpeg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
            ...
            <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup4.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px] w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup5.jpeg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup6.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
        ...
        <div className="mt-[64px] flex gap-[18px]">
            <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup7.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup8.jpeg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup9.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup10.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup11.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
              ...
              <div className=" bg-[#1F1D2B] rounded-[18px]  w-[200px] h-[226px] flex flex-col items-center">
                <div className="w-[200px] h-[226px] flex justify-center items-center -mt-[50px]">
                  <img src="images/soup12.jpg" alt="image" className="rounded-t-lg w-[132px] h-[132px] object-cover" />
                </div>
