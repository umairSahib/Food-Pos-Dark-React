...
const Orders = () => {
  return (
    <div>
         <div className="bg-[#1F1D2B] basis-3/10 h-[834px] rounded-tr-8 rounded-br-8 pt-6 pl-6 pr-6">
    ...
    <div className="mt-6">
      <div className="flex gap-3 w-96 h-12 items-center">
        <img src="images/hotdish2.png" alt="image" className="w-10 h-10 "/>
         <div className="">
        ...
        <div className="flex gap-3">
          <input type="text" className=" bg-[#2D303E] w-12 h-12 px-4 rounded text-[#889898] ml-14 placeholder-gray-500" placeholder="2"/>
       ...
       <div className="flex justify-center gap-4 mt-2 ">
        ...
        <button className=" bg-[#1F1D2B] p-4 rounded border border-[#FF7CA3] hover:bg-[#50343a]"><i className="fa-solid fa-trash-can text-[#FF7CA3] text-normal"></i></button>
      </div>
    </div>
    <div className="mt-6">
      <div className="flex gap-3 w-96 h-12 items-center">
        <img src="images/hotdish4.png" alt="image" className="w-10 h-10 "/>
         <div className="">
         ...
         <input type="text" className=" bg-[#2D303E] w-12 h-12 px-4 rounded text-[#889898] ml-10 placeholder-gray-500" placeholder="1"/>
       ...
       <div className="flex justify-center gap-4 mt-2 ">
        ...
        <button className="flex items-center justify-center bg-[#1F1D2B] p-4 rounded border border-[#FF7CA3] hover:bg-[#50343a]"><i className="fa-solid fa-trash-can text-[#FF7CA3] text-normal"></i></button>
      </div>
    </div>
    <div className="mt-6">
      <div className="flex gap-3 w-96 h-12 items-center">
        <img src="images/hotdish6.png" alt="image" className="w-10 h-10 "/>
         <div className="">
         ...
         <input type="text" className=" bg-[#2D303E] w-12 h-12 px-4 rounded text-[#889898] ml-[46px] placeholder-gray-500" placeholder="3"/>
    ...
    <div className="mt-6">
      <div className="flex gap-3 w-96 h-12 items-center">
        <img src="images/hotdish8.png" alt="image" className="w-10 h-10 "/>
         <div className="">
    ...
    <div className="w-96 h-12 bg-[#EA7C69] p-4 rounded flex items-center justify-center mt-10 hover:bg-[#50343a]">
